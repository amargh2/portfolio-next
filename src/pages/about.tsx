        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-3 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-second lg:row-span-2 flex justify-center m-2">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I’m Anthony Margherio. I'm a self-taught developer living in Chicago, Illinois.
            </h1>
              <p>
                ...
                as a flight attendant, English teacher in South Korea, and backpacker. While I wouldn't change a thing,
                nearly a decade in the air coupled with the pandemic left me thinking about 
                new challenges, old passions, and where I wanted to land.
                I had worked in a small IT department at my university doing desktop support in the past and 
                really enjoyed the problem solving and learning I got to do in the job, 
                so I decided to update my knowledge and explore my interests in tech.
                </p>
                <p>
                After earning some certifications in networking and operating systems 
                through self-study and getting some exposure to Python, I decided to
                start learning full-stack development on my own through a free, open source bootcamp and 
              ...
              <p>
                ...
                TypeScript. I'm hoping to continue to learn while contributing my existing skills
              ...
              <p> 
                ...
                nonfiction. I also meditate daily, am a vegetarian, and consider myself a pretty calm, kind guy. Thanks for passing
                through, and don't hesitate to reach out if you'd like to work together. :)
