...
export default function HomeAboutPanel() {
    return (    
    <div className='flex bg-white md:flex-row flex-col rounded-lg gap-2 shadow-md p-2 ring-1 ring-indigo-200'>
        ...
        <div>  
          ...
          <div className='flex justify-center m-10'>
            ...
            reading, and writing. I currently work in IT support and hold several technical certifications. 
            I also a BA in English and am enthusiastic about 
